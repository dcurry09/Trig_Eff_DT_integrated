#ifndef __UF_STYLE_MACROS__
#define __UF_STYLE_MACROS__ (1)
...
//------------------------------------------------------------------------------
void PrintIt(TCanvas *pad, TString title)//char *title)
{
...
void PrintItLog(TPad *pad, TString title)//char *title)
{
  ...
  double xpos = xmin + 0.50*(xmax - xmin);
  double ypos = 2*TMath::Power(10,ymax);// + TMath::*(ymax - ymin);
