...
// Phi/Eta Resolutions
// ------------------------------------------------------------------------------
TH1F* hdphi_csc = new TH1F("dphi_csc", "", 100, 0.2, 0.2);
...
// new non scales phi plots
int phi_bin = 50;
TH1F* new_hNTriggeredMuonsVsPhi = new TH1F("hNTriggeredMuonsVsPhi","", phi_bin, -Pi, Pi);
TH1F* new_hNMuonsVsPhi          = new TH1F("hNMuonsVsPhi","", phi_bin, -Pi, Pi);
